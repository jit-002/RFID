...
demo.tsx
import { Component } from "@/components/ui/claude-style-ai-input";
...
```bash
lucide-react, @radix-ui/react-slot, class-variance-authority, @radix-ui/react-toggle
```
